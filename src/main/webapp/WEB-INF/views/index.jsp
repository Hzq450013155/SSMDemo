...
<body>
<div>
    <a id="logout" class="btn btn-danger" href="/logout">注销</a>
</div>
<div class="container">
    <div class="row">
        <div class="col-lg-2">
            <ul class="nav nav-pills nav-stacked">
                <li role="presentation" class="active"><a href="#" onclick="changeSrc('/todoItemController?getList')">待办事项列表</a>
                </li>
                <li role="presentation"><a href="#" onclick="changeSrc('/views/infoMaintenance.jsp')">个人信息维护</a></li>
            </ul>
        </div>
        <div class="col-lg-10">
